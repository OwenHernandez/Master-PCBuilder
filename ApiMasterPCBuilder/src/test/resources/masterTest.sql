...
CREATE TABLE `components` (
                              ...
                              `AMAZON_PRICE` decimal(10, 0) NOT NULL,
                              `EBAY_PRICE`   decimal(10, 0) NOT NULL,
...
INSERT INTO `users` VALUES
                        (1, 'user1', 'user1@example.com', 'password1', 'user1.jpg', 1, 'hash1', 'ROLE_ADMIN', 1),
                        (2, 'user2', 'user2@example.com', 'password2', 'user2.jpg', 1, 'hash2', 'ROLE_USER', 1),
                        (3, 'Coso', 'coso8610@gmail.com', '$2a$10$SZEU19//bprJ96NKVUj9cubMwrF0SFme21kqLj6iHr/4S/vdnYS6G', 'Coso_1000000033_1.jpg', 1, '$2a$10$JGz5Ymj0rPnICzmh5WAlU.Xeui1OP7umdaFJxNLurTY9CY8Zgmm/u', 'ROLE_ADMIN', 0),
                        (4, 'user3', 'user3@example.com', 'password3', 'user3.jpg', 1, 'hash3', 'ROLE_USER', 0);

INSERT INTO `sellers` VALUES
                          (1, 'TechStore', 'techstore_logo.jpg', 0),
                          (2, 'PCParts', 'pcparts_logo.jpg', 0),
                          (3, 'ElectroGadgets', 'electrogadgets_logo.jpg', 0);

INSERT INTO `builds` VALUES
                         (1, 'Gaming PC', 'High-end gaming PC build', 1500.00, 1, 'Gaming', 576437878532, 0),
...
INSERT INTO `posts` VALUES
                        (1, 'My Gaming PC Setup', 'Coso_1000000033.jpg', 'Just finished building my dream gaming PC!', 2, 1, 0),
                        (2, 'Video Editing Rig', 'video_editing.jpg', 'Check out my new video editing setup!', 2, 2, 0),
                        (3, 'Budget PC Build', 'budget_build.jpg', 'Built a budget-friendly PC for everyday use.', 2, 1, 0);

INSERT INTO `components` VALUES
                             (1, 'Graphics Card', 'Coso_1000000036.jpg', 'NVIDIA RTX 3080', 800.00, 800.00, 700.00, 1, 1, 'GPU', 0),
                             (2, 'Processor', 'Coso_1000000034.jpg', 'AMD Ryzen 7 5800X', 400.00, 400.00, 300.00, 2, 3, 'CPU', 0),
                             (3, 'Memory', 'Coso_1000000037.jpg', 'Corsair Vengeance 16GB', 120.00, 120.00, 60.00, 3, 2, 'RAM', 0);

INSERT INTO `builds_components` VALUES
                                    (1, 1, 1, 800.00, 1704153600000),
                                    (2, 1, 2, 400.00, 1704153600000),
                                    (3, 2, 3, 120.00, 1704153600000);

INSERT INTO `group_chats` VALUES
                              (1, 'CosoGroup', 'fsdfdsgdfs', 1711411200000, 1, 'jgfkhfg', 0),
                              (2, 'CosoGroupOG!!', 'A group for all the coso enjoyers!!', 1711584000000, 3, 'GroupChat12_1000000033.jpg', 1);

INSERT INTO `group_chats_users` VALUES
                                    (1, 1, 1),
                                    (2, 1, 2),
                                    (3, 1, 3);
...
INSERT INTO `price_history` VALUES
                                (1, 1, 800, 800, 700, 1711616043),
                                (2, 2, 400, 400, 300, 1711616047),
                                (3, 3, 120, 120, 60, 1711616051);