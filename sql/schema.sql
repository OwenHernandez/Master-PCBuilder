...
CREATE TABLE USERS(
    ...
    CONSTRAINT FK_FRIEND_USER FOREIGN KEY(FRIEND_ID)
);
...
CREATE TABLE BUILDS(
    ...
    CONSTRAINT FK_USER_BUILD FOREIGN KEY(USER_ID)
);
...
CREATE TABLE POSTS(
    ...
    CONSTRAINT FK_BUILD_POST FOREIGN KEY(BUILD_ID),
...
CREATE TABLE SELLERS(
    ...
    CONSTRAINT UQ_NAME_SELLER FOREIGN KEY(NAME)
);
...
CREATE TABLE COMPONENTS(
    ...
    CONSTRAINT FK_SELLER_COMPONENT PRIMARY KEY(SELLER_ID)
);
...
CREATE TABLE BUILDS_COMPONENTS(
    ...
    CONSTRAINT FK_BUILD_BUILD_COMPONENT FOREIGN KEY(BUILD_ID),
    CONSTRAINT FK_COMPONENT_BUILD_COMPONENT FOREIGN KEY(COMPONENT_ID)
);